(() => {
  ...
  function init() {
    ...
    document.addEventListener('click', event => {
      if (!event.target.closest('#calcBtn,#addDedBtn,#addManDedBtn,#addNonExecBtn,[data-mode]')) return;
      window.requestAnimationFrame(() => patchText(document.body));
    });
    ...
    window.setTimeout(() => patchText(document.body), 0);
  }
