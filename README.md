...
- testele și verificarea sintactică pentru aplicația principală, inclusiv modulul AI Documente;
...
- AI Documente este în versiune **ALPHA**: OCR-ul și extragerea automată trebuie verificate înainte de calcul. Fișierele sunt procesate în browser de acest modul, fără backend propriu; bibliotecile PDF/OCR și resursele OCR sunt încărcate din surse externe.
