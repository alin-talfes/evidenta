...
const SHELL_CACHE = 'evidenta-ai-shell-v16';
const RUNTIME_CACHE = 'evidenta-ai-runtime-v16';
...
const SHELL_PATHS = [
  ...
  '../css/style.css', '../css/design-system.css', '../css/operational-upgrades.css', '../css/mobile.css', '../css/mobile-modules.css', '../css/disclosure-hardening.css',
  ...
  '../js/mobile-operational-v2.js', '../js/pwa-register.js'
];
...
function isCriticalSharedRuntime(url) {
  return /\/js\/(?:version|ux-upgrades|operational-navigation|operational-ai|no-nonoptional-disclosures-v1|disclosure-hardening-v2|pwa-register|mobile-operational-v2)\.js$/i.test(url.pathname)
    || /\/css\/(?:mobile|mobile-modules|operational-upgrades|disclosure-hardening)\.css$/i.test(url.pathname);
}
