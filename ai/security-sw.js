...
const SHELL_CACHE = 'evidenta-ai-shell-v9';
const RUNTIME_CACHE = 'evidenta-ai-runtime-v9';
...
const SHELL_PATHS = [
  ...
  '../css/style.css', '../css/design-system.css', '../css/operational-upgrades.css', '../css/mobile-operational-v2.css', '../css/pedepse-modes-v3.css', '../css/disclosure-hardening.css', '../css/pwa-mobile.css', '../css/mobile-bottom-nav-clearance-v5.css',
...
function isCriticalSharedRuntime(url) {
  return /\/js\/(?:version|pwa-register)\.js$/i.test(url.pathname)
    || /\/css\/mobile-bottom-nav-clearance-v5\.css$/i.test(url.pathname);
}
