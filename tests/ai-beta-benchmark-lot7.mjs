...
// Benchmark derivat din fotografii reale de lucru, dar complet anonimizat/pseudonimizat.
...
assert.equal(a.startDate,'','Data emiterii mandatului nu este data începerii executării.');
...
console.log('AI BETA benchmark lot 7: mandate fotografiate real-world, anonimizate — concurs 1/3, deducere simplă și deduceri mixte.');
