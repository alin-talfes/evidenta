...
const CORE_PATHS = [
  ...
  './js/no-nonoptional-disclosures-v1.js', './js/mobile-operational-v2.js', './js/pedepse-modes-v5.js', './js/pedepse-prison-date.js',
